...
visibility: "public"
description: 【本体论与FDE入门】把"本体论/Ontology 是什么、FDE 是什么岗位、为什么企业 AI 项目八成栽在这一步"讲成人话——先问你处境再答，答完给下一步，用 197 条本体论原子当依据。管的是"我自己/我们公司/我的团队"要不要做这件事的判断，不是帮别人的客户做。用户说「本体论到底是什么」「Ontology 跟知识图谱有什么区别」「FDE 是干嘛的」「为什么我们上了 RAG 还是不好用」「Palantir 那套是怎么回事」「要不要给我们公司建本体」「我的公司/我们团队适不适合做FDE」「我们要不要做AI变革/AI改造，从哪开始」「值不值得投入本体论」时使用——只要问的是自己/自己公司要不要做，不管有没有出现"企业"两个字，都算本skill；问的是帮别人的客户做，走xy-fde。｜小爷出品
---
...
| 我自己/我们公司/我的团队要不要做FDE、建本体、做AI变革改造（第一人称判断，不管有没有出现"企业"两个字） | 本 skill |
| 给别人企业做 AI 落地咨询：这单接不接、标品还是定制、怎么报价、组织阻力（第三方视角——这个客户、某个企业、对方公司、这单） | `xy-fde` |
