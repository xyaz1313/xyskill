...
**风物执守 · XY 操盘系统**（对外英文/GitHub 名 **XY Skill**）——一套装进 Claude Code / Codex / 豆包等 Agent 里的商业与私域操盘顾问。作者是商业博主"小爷"，本人有十几年、多次从 0 到过亿的私域操盘经验。这个项目把他的实战判断沉淀成 **46 个可直接调用的 Skill** 和 **28,226 条知识原子**，每个判断都带原子编号可查。
